    ...
    return <div className="header">
        ...
        <div className="header_first_row">
            ...
            <div className="header_first_row_first_section">
                ...
                <div className="logo" >
                    ...
                    <Link className="logo_image" to="/home" >
                        ...
                        <img className="logo_image" src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/db/TATA_1mg_Logo.svg/2560px-TATA_1mg_Logo.svg.png" alt="Logo_img" />
            ...
            <div className="header_first_row_second_section">
                ...
                <div className="login_signup"> <span id="login_button">Login</span> | <span id="signup_button" >Signup</span></div>
        ...
        <div className="header_second_row">
            ...
            <div className="header_second_row_second_section">
                ...
                <div className="discount_icon">
                    ...
                    <img src="https://res.cloudinary.com/du8msdgbj/image/upload/v1570695364/quick_buy_rebrand_lqpnce.svg" alt="discount-Icon" />

                </div>

                <div className="discount_tag">QUICK BUY! Flat 25% off on medicines*</div>
        ...
        <div className="header_third_row">
            {/* -------------------- */}
            <div className="drop_down">All Medicines <i className="fa fa-angle-down" aria-hidden="true"></i>

                <div className="drop_down_content">

                    <ul className="dropdown_first_heading" >Medicine by theropatic className</ul>
            ...
            <div className="drop_down">Winter care <i className="fa fa-angle-down" aria-hidden="true"></i>
                <div className="drop_down_content">
            ...
            <div className="drop_down">Featured <i className="fa fa-angle-down" aria-hidden="true"></i>
                ...
                <div className="drop_down_content">
                    ...
                    <ul className="dropdown_first_heading" ><h3>Top Brands</h3>
            ...
            <div className="drop_down">Covin Essentials <i className="fa fa-angle-down" aria-hidden="true"></i>
                <div className="drop_down_content">
            ...
            <div className="drop_down">Fitness & Supplements <i className="fa fa-angle-down" aria-hidden="true"></i>
                <div className="drop_down_content">
                    <ul className="dropdown_first_heading" >
                        Vitamins & Supplements
                        <li className="dropdown_second_heading" onclick="window.location.href = 'multivitamins.html'">Multivitamins</li>
                        <li className="dropdown_second_heading" onclick="window.location.href = 'vitamins_A-Z.html'">Vitamins A-Z</li>
                        <li className="dropdown_second_heading" onclick="window.location.href = 'MineralSupplements.html'">Mineral Supplements</li>
                    ...
                    <ul className="dropdown_first_heading" >
                        Health food & Drinks
                        <li className="dropdown_second_heading">Green Tea & Herbal Tea</li>
                    </ul>
                    <ul className="dropdown_first_heading" >
                        Protien Supplements
                    ...
                    <ul className="dropdown_first_heading">
                        Weigth Management
                        <li className="dropdown_second_heading">Weigth Management Herbs</li>
                    </ul>
                </div>
            </div>
            ...
            <div className="drop_down">Diabetes <i className="fa fa-angle-down" aria-hidden="true"></i>
                <div className="drop_down_content">
                    <ul className="dropdown_first_heading" >Device
                    ...
                    <ul className="dropdown_first_heading" >Diabitic Medicines
                        <li className="dropdown_second_heading">Vitamins,Minerals & Antioxidents</li>
                    ...
                    <ul className="dropdown_first_heading" >Diabetic Diet
            ...
            <div className="drop_down">Healthcare Device <i className="fa fa-angle-down" aria-hidden="true"></i>

                <div className="drop_down_content">

                    <ul className="dropdown_first_heading">Masks(N95, Surgical & More)</ul>
            ...
            <div className="drop_down">Personal Care <i className="fa fa-angle-down" aria-hidden="true"></i></div>

            <div className="drop_down">Health Condition <i className="fa fa-angle-down" aria-hidden="true"></i></div>

            <div className="drop_down">Ayurveda Products <i className="fa fa-angle-down" aria-hidden="true"></i></div>

            <div className="drop_down">Homeopathy <i className="fa fa-angle-down" aria-hidden="true"></i></div>
