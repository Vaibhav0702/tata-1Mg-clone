          ...
          <div>
            <form>
              <input
                ...
                maxlength="10"
                autocomplete="off"
                valuepattern="[6-9]\d{9}"
                required
              />
              <button type="submit" id="butn">
                Send Link
              </button>
            </form>
          </div>
        ...
        <div id="container">
          <div id="uppercontainer">
            ...
            <div id="connect">
              <h3>Connect</h3>
              <div>
                <p className="msg">social link</p>
              </div>
              <div id="logo1">
                <div id="facbook">
                  <a href="https://www.facebook.com/1mgOfficial">
                    <img
                      src="	https://www.pngarts.com/files/10/Facebook-Logo-Black-And-White-PNG-Background-Image.png"
                      width="30"
                      height="30px"
                      alt="gvdrf"
                    />
                ...
                <div id="twitter">
                  <a href="https://www.twitter.com/1mgOfficial">
                    {" "}
                    <img
                ...
                <div id="youtube">
                  <a href="https://www.youtube.com/c/1mgofficial">
                    <img
                      src="	https://www.vectorico.com/download/social_media/youtube-dark-squircle.png"
                      width="30px"
                      height="30px"
                      alt=""
                    />{" "}
                ...
                <div id="linkedin">
                  <a href="https://www.linkedin.com/company/1mg">
                    <img
                ...
                <div id="medium">
                  ...
                  <a href="https://medium.com/1mgofficial">
                    <img
                      src="	https://res.cloudinary.com/du8msdgbj/image/upload/v1601285810/marketing/jf3bry3wl6zzkd14yces.svg"
                      height="30px"
                      alt=""
                    />
                  </a>
              ...
              <div>
                <p className="msg">Want daily dose of health?</p>
              </div>
              <div>
